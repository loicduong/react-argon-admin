              ...
              <div className="card z-index-0">
                ...
                <div className="row px-xl-5 px-sm-4 px-3">
                  ...
                  <div className="mt-2 position-relative text-center">
                    <p
                      className="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3"
                    >or</p>
                  </div>
                </div>
                <div className="card-body">
                  <form role="form">
                    <ArgonInput type="text" placeholder="Name" aria-label="Name" />
                    <ArgonInput type="email" placeholder="Email" aria-label="Email" />
                    <ArgonInput type="password" placeholder="Password" aria-label="Password" />
                    ...
                    <div className="text-center">
                      <ArgonButton fullWidth color="dark" variant="gradient" className="my-4 mb-2">Sign up</ArgonButton>
                    </div>
